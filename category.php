...
<body>
    ...
    <section id="cat">
        <?php
            $cat=$_GET['cat'];
            echo "<div id='cname'>Category<span>>></span>".ucfirst($cat)."</div>";
        ?>
    </section>
    <section id="branditems">
        <div class="container">
            ...
            <?php
                ...
                $q="SELECT DISTINCT pname FROM productdet where pcat='$cat'";
                ...
                for($i=0;$i<$num;$i++){
                    ...
                    for ($j=0;$j<$num1;$j++){
                        ...
                        if ($j==0){
                            ...
                            echo "<form class='prodform' method='POST' action='addprod.php?pro=categ$row1[6]'>";
                            $ls='yes';
                        }
                            echo"                          
