    ...
    <section>
        <div class="container">
            <?php
                ...
                $q="SELECT DISTINCT pname FROM productdet where ((pcat like '%$key%') or (pbrand like '%$key%') or (pname like '%$key%'))";
                ...
                if($num==0){
                    echo "<div class='cbox' style='text-align:center;margin-top:20px;'>";
                    echo "<i class='fas fa-shopping-cart fa-5x' style='font-size:200px;color:rgba(0,0,0,0.7);'></i>";
                    echo "<p style='font-size:20px;font-weight:bold'>OOPS! No items found for your search.</p>";
                    echo "<p style='font-size:17px;'>Try searching something else!</p></div>";
                }
                else{
                echo "<p id='head'><b>Showing items related to '$key'</b> </p>
                <div class='box'>";
                for($i=0;$i<$num;$i++){
                    ...
                    for ($j=0;$j<$num1;$j++){
                        ...
                        echo "<form class='prodform' method='POST' action='addprod.php?pro=searc$key'>";
                        $ls='yes';
                    }
                            echo"                          
